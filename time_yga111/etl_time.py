        ...
        for k in range(len(year)):
            for j in range(len(mon)):
                ...
                if os.path.exists(file):
                    ...
                    # deleta data with year less than 2017 or greater than 2021
                    # deleta data with total amount less than or equal to 2.5
                    # delete data with LocationID = 264 or 265, unknown location
                    # add duration column and delete data with duration less than or equal to 0 and longer than or equal to 100 min
                    # add speed column with trip_distance/duration and delete data with speed less than or equal to 0 and greater than or equal to 100km/h
